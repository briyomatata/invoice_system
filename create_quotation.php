...
<div class="container py-5">
  <h2 class="py-4">Create New Quotation</h2>
  <form action="save_quotation.php" method="POST" class="card p-4 shadow-sm bg-white" id="quotationForm">
    ...
    <button type="submit" class="btn btn-primary btn-sm d-block mx-auto" style="width:150px;">Save Quotation</button>
  </form>
</div>
